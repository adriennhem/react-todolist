...
var ToDoList = function (_React$Component2) {
  ...
  _createClass(ToDoList, [{
    ...
    value: function fetchTasks() {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=211").then(checkStatus).then(json).then(function (response) {
    ...
    value: function deleteTask(id) {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks/" + id + "?api_key=211", {
        method: "DELETE",
        cors: "cors"
    ...
    value: function toggleComplete(id, completed) {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks/" + id + "/mark_complete?api_key=211", {
        method: "PUT",
        cors: "cors"
      }).then(checkStatus).then(json).then(function (data) {
        _this5.fetchTasks();
    ...
    value: function handleSubmit(event) {
      ...
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=211", {
        method: "POST",
        mode: "cors",
